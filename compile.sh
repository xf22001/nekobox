...
#   修改日期：2025年03月31日 星期一 15时23分30秒
#   描    述：
#
#================================================================
function main() {
	...
	export GOOS=linux
	export GOARCH=amd64
	export TAGS_GO120="with_gvisor,with_dhcp,with_wireguard,with_reality_server,with_clash_api,with_v2ray_api,with_quic,with_utls"
	export TAGS_GO121="with_ech"
	export TAGS="$TAGS_GO120,$TAGS_GO121"
