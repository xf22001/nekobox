...
#   修改日期：2025年10月07日 星期二 16时39分30秒
#   描    述：
#
#================================================================
function main() {
	...
	export GOOS=linux
	export GOARCH=amd64
	export TAGS="with_gvisor,with_quic,with_dhcp,with_wireguard,with_utls,with_acme,with_clash_api,with_v2ray_api,with_tailscale,badlinkname,tfogo_checklinkname0"
