...
const file_libcore_proto_rawDesc = "" +
	...
	"\x0eis_pre_release\x18\x06 \x01(\bR\fisPreRelease*B\n" +
	"\bTestMode\x12\v\n" +
	...
	"\n" +
	"QueryStats\x12\x16.libcore.QueryStatsReq\x1a\x17.libcore.QueryStatsResp\"\x00B\x19Z\x17nekoray/grpc_server/genb\x06proto3"
...
var file_libcore_proto_depIdxs = []int32{
	...
	3,  // 9: libcore.LibcoreService.Exit:output_type -> libcore.EmptyResp
	11, // 10: libcore.LibcoreService.Update:output_type -> libcore.UpdateResp
	4,  // 11: libcore.LibcoreService.Start:output_type -> libcore.ErrorResp
	4,  // 12: libcore.LibcoreService.Stop:output_type -> libcore.ErrorResp
	7,  // 13: libcore.LibcoreService.Test:output_type -> libcore.TestResp
	9,  // 14: libcore.LibcoreService.QueryStats:output_type -> libcore.QueryStatsResp
